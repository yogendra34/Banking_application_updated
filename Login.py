...
def login():
    ...
    while True:
        ...
        print("5. Show beneficiary....")
        print("6. add_beneficiary....")
        print("Thank you .........")
        inp=input("Enter the no you want to proceed...... : ")
        if inp=='1':
            ...
            add_beneficiary(username)
        else:
            print("Invalid choice.....")
        inp2 = input('Enter 1 to view options again or any other key to exit : ')
        if inp2 == '1':
            pass
        else:
            break
